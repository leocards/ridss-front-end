            ...
            <div className="mt-6">
                <Card className="gap-0 overflow-hidden rounded-md p-0 shadow-xs">
                    <div className="bg-primary text-primary-foreground grid h-12 grid-cols-5 items-center px-3 [&>div]:not-first:text-center">
                        ...
                        <div className="">
                            <TypographySmall>Vials Unopen</TypographySmall>
                        </div>
                        <div className="">
                            <TypographySmall>Opened Vials</TypographySmall>
                        </div>
                        <div className="">
                            <TypographySmall>Exp. for Open Vials</TypographySmall>
                        </div>
                    </div>
                    <div className="divide-y">
                        {["Bacillus-Calmette-Guerin", "Hepatitis B", "Pneumococcal Conjugate Vaccine"].map(
                            (vac, index) => (
                                <div
                                    key={index}
                                    className="grid h-11 grid-cols-5 items-center px-3 [&>div]:not-first:text-center"
                                >
                                    <div className="col-span-2">
                                    ...
                                    <div className="">
                                        <TypographySmall className="">Nov. 28, 2025</TypographySmall>
                                    </div>
                                </div>
                            ),
                        )}
