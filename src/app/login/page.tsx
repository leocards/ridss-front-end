        ...
        <div className="flex h-full flex-col items-center justify-center p-12 text-center">
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <h1 className="text-primary-foreground text-5xl font-bold">RIDSS</h1>
      ...
      <div className="bg-background flex w-full items-center justify-center p-8 lg:w-2/3">
        <div className="w-full max-w-md space-y-10 py-24 lg:py-32">
          <div className="space-y-4 text-center">
            <div className="font-medium tracking-tight uppercase text-3xl">Login</div>
            <div className="text-muted-foreground mx-auto max-w-xl">
              Welcome back. Enter your username/email and password, let&apos;s hope you remember them this time.
            </div>
          </div>
